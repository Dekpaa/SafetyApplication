        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                Text(
                  'Body Protection to safeguard the body from exposure to hazardous chemicals, heat, fire, or other physical hazards that could result in burns, skin irritation, or other physical injuries.',
...
class CardItem extends StatelessWidget {
  ...
  final List<String> textData = [
    'ALUMINISED JACKET AND PANTS',
    'JACKET    AND TROUSER',
    'FIRE RETARDANT JACKET AND PANTS',
    'CHEMICAL APRON',
    'FULL BODY HARNESS',
  ];
  ...
  Widget build(BuildContext context) {
    return FlipCard(
      ...
      front: Card(
        color:Color.fromARGB(255, 209, 149, 107),
